    ...
    public class CustomersDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Customer>(entity =>
            {
                ...
                _logger.LogInformation("Primary key configured for Customer entity.");

                // Configuring properties with constraints
                entity.Property(e => e.Name).IsRequired().HasMaxLength(200);
                _logger.LogInformation("Name property configured with IsRequired and MaxLength(200).");

                entity.Property(e => e.Email).IsRequired().HasMaxLength(200);
                _logger.LogInformation("Email property configured with IsRequired and MaxLength(200).");

                entity.Property(e => e.Phone).HasMaxLength(20);
                _logger.LogInformation("Phone property configured with MaxLength(20).");
            });
