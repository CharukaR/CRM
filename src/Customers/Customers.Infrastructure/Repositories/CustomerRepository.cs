...
public class CustomerRepository : ICustomerRepository
{
    ...
    {
        _logger.LogInformation("Starting AddAsync method for customer: {CustomerName}", customer.Name);
        
        await _context.Customers.AddAsync(customer, cancellationToken);
        await _context.SaveChangesAsync(cancellationToken);
        
        _logger.LogInformation("Customer: {CustomerName} added successfully with id: {Id}", customer.Name, customer.Id);
    ...
    {
        _logger.LogInformation("Starting UpdateAsync method for customer id: {Id}", customer.Id);
    ...
    {
        _logger.LogInformation("Starting DeleteAsync method for customer id: {Id}", id);
